...
const ItemCount = ({ mensagemDeLimite, contagem, contador, addItemToCart }) => {
    return (
        <div className="item__count">
            ...
            <button onClick={() => addItemToCart(contador)} className="btn__secondary">Adicionar ao carrinho</button>
        </div>
    );
}
